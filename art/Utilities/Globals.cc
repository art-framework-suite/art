...
ProductInfo::
ProductInfo(ConsumableType const consumableType, TypeID const& tid, string const& label, string const& instance,
...
std::string
ConsumesInfo::
module_context(ModuleDescription const& md)
{
...
void
ConsumesInfo::
setRequireConsumes(bool const val)
{
