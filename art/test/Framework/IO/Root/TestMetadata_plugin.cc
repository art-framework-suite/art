...
void
arttest::TestMetadata::beginJob()
{
  std::cout << "TestMetadataPlugin::beginJob()" << std::endl;
}

void
arttest::TestMetadata::endJob()
{
  std::cout << "TestMetadataPlugin::endJob()" << std::endl;
}

void
arttest::TestMetadata::collectMetadata(art::Event const&)
{
  std::cout << "TestMetadataPlugin::collectMetadata()" << std::endl;
}

void
arttest::TestMetadata::beginRun(art::Run const&)
{
  std::cout << "TestMetadataPlugin::beginRun()" << std::endl;
}

void
arttest::TestMetadata::endRun(art::Run const&)
{
  std::cout << "TestMetadataPlugin::endRun()" << std::endl;
}

void
arttest::TestMetadata::beginSubRun(art::SubRun const&)
{
  std::cout << "TestMetadataPlugin::beginSubRun()" << std::endl;
}

void
arttest::TestMetadata::endSubRun(art::SubRun const&)
{
  std::cout << "TestMetadataPlugin::endSubRun()" << std::endl;
}

auto
arttest::TestMetadata::produceMetadata() -> collection_type
{
