...
BOOST_AUTO_TEST_CASE(NoConfig)
{
  ...
  BOOST_TEST_REQUIRE(artapp(1, const_cast<char**>(strings)) == 89);
}

BOOST_AUTO_TEST_CASE(testHelp)
{
  char const* strings[] = {"artapp_t", "--help"};
  BOOST_TEST_REQUIRE(artapp(2, const_cast<char**>(strings)) ==
...
BOOST_AUTO_TEST_CASE(testParallelism1)
{
  ...
  BOOST_TEST_REQUIRE(artapp(4, const_cast<char**>(strings)) == 0);
}
...
BOOST_AUTO_TEST_CASE(testParallelism4)
{
  ...
  BOOST_TEST_REQUIRE(artapp(5, const_cast<char**>(strings)) == 0);
}
...
BOOST_AUTO_TEST_CASE(testParallelism5)
{
  ...
  BOOST_TEST_REQUIRE(artapp(5, const_cast<char**>(strings)) == 89);
}
