#ifndef art_test_Framework_Services_Registry_old_stubs_DummyService_h
#define art_test_Framework_Services_Registry_old_stubs_DummyService_h
// -*- C++ -*-
//
...
#endif /* art_test_Framework_Services_Registry_old_stubs_DummyService_h */
