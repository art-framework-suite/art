#ifndef test_Framework_Services_Registry_old_stubs_DummyService_h
#define test_Framework_Services_Registry_old_stubs_DummyService_h
// -*- C++ -*-
//
...
#endif /* test_Framework_Services_Registry_old_stubs_DummyService_h */
