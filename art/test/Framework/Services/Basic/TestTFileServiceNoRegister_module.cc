...
public:
  ...
  struct Config {
    fhicl::Atom<bool> expectThrow{fhicl::Name{"expectThrow"},
        fhicl::Comment{"In the case that services.TFileService.fileProperties is specified\n"
