...
BOOST_AUTO_TEST_CASE(Construct)
{
  ...
  test_sets.emplace_back(
    ...
    "  \n"
    "---- Configuration END\n"); // Incorrectly included parameter in
                                 // "physics" block
  test_sets.emplace_back("process_name: MisspecifiedEndPath\n"
                         ...
                         "---- Configuration END\n"); // Incorrectly included
                                                      // end path as trigger
                                                      // path
  test_sets.emplace_back("process_name: MisspecifiedTriggerPath\n"
                         "physics.producers.d1: {\n"
                         "   module_type: "
                         "\"art/test/Framework/Art/PrintAvailable/"
                         "DummyProducer\"\n"
                         "}\n"
                         "physics.p1: [d1]\n"
                         ...
                         "  Path configuration: The following were encountered "
                         "while processing path configurations:\n"
                         "    ERROR: Path 'p1' is configured as an end path "
                         "but is actually a trigger path.\n"
                         "---- Configuration END\n"); // Incorrectly included
                                                      // trigger path as end
                                                      // path
