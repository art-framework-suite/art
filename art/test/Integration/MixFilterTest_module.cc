  ...
  readMode_(helper.readMode())
{
  ...
  std::string mixProducerLabel(p.get<std::string>("mixProducerLabel", "mixProducer"));
  ...
  helper.declareMixOp(art::InputTag{mixProducerLabel, "doubleLabel"}, &MixFilterTestDetail::mixByAddition<double>, *this);
  helper.declareMixOp(art::InputTag{mixProducerLabel, "IntProductLabel"}, &MixFilterTestDetail::mixByAddition<arttest::IntProduct>, *this);
  helper.declareMixOp(art::InputTag{mixProducerLabel, "stringLabel", "SWRITE"}, &MixFilterTestDetail::mixByAddition<std::string>, *this);
  helper.declareMixOp(art::InputTag{mixProducerLabel, "doubleCollectionLabel"}, &MixFilterTestDetail::aggregateDoubleCollection, *this);
  helper.declareMixOp(art::InputTag{mixProducerLabel, "doubleVectorPtrLabel"}, &MixFilterTestDetail::mixPtrs, *this);
#ifndef ART_NO_MIX_PTRVECTOR
  helper.declareMixOp(art::InputTag{mixProducerLabel, "doublePtrVectorLabel"}, &MixFilterTestDetail::mixPtrVectors, *this);
#endif
  helper.declareMixOp(art::InputTag{mixProducerLabel, "ProductWithPtrsLabel"}, &MixFilterTestDetail::mixProductWithPtrs, *this);
  helper.declareMixOp(art::InputTag{mixProducerLabel, "mapVectorLabel"}, &MixFilterTestDetail::aggregate_map_vector, *this);
  helper.declareMixOp(art::InputTag{mixProducerLabel, "intVectorPtrLabel"}, &MixFilterTestDetail::mixmap_vectorPtrs, *this);
  ...
  helper.declareMixOp(art::InputTag{mixProducerLabel, "SpottyProductLabel"}, mixfunc, false);
  // SubRun mixing.
  helper.declareMixOp<art::InSubRun>(art::InputTag{mixProducerLabel, "DoubleSRLabel"}, "SRInfo", &MixFilterTestDetail::mixSRProduct, *this);
  // Run mixing.
  helper.declareMixOp<art::InRun>(art::InputTag{mixProducerLabel, "DoubleRLabel"}, "RInfo", &MixFilterTestDetail::mixRProduct, *this);
}
