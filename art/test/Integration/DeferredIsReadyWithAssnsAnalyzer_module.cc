...
arttest::DeferredIsReadyWithAssnsAnalyzer::DeferredIsReadyWithAssnsAnalyzer(fhicl::ParameterSet const & p)
  :
  EDAnalyzer(p),
  inputLabel_(p.get<std::string>("input_label"))
{}

void arttest::DeferredIsReadyWithAssnsAnalyzer::analyze(art::Event const & e)
{
