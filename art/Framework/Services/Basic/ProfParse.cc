...
void writeProfileData(int fd, const std::string& prefix)
{
  ...
  while(pat_it_beg!=pat_it_end) {
	  ...
	  Viter::iterator sym_iter = upper_bound(vsyms.begin(),
						 vsyms.end(),
						 *cop_beg,
						 idComp);
