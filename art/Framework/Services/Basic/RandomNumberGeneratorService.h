#ifndef FWCore_Services_RandomNumberGeneratorService_h
#define FWCore_Services_RandomNumberGeneratorService_h
...
// ------------
//
// Via this RandomNumberGeneratorService, the CLHEP random number engines
...
//     specified parameter:
//
//       createEngine( pset.getUntrackedParameter<int>("seed",13597) );
//
...
// ---------------
//
// To gain general access to this RandomNumberGeneratorService, a module
// uses the facilities of the Service subsystem.  Thus, after #including
...
// Then in a later process, the RandomNumberGeneratorService is capable of restoring
...
namespace edm {
  ...
  private:
    ...
    void  operator = ( RandomNumberGeneratorService const & );
...
#endif  // FWCore_Services_RandomNumberGeneratorService_h
