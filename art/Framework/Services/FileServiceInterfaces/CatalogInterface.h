...
inline void
art::CatalogInterface::configure(std::vector<std::string> const& items)
{
...
inline int
art::CatalogInterface::getNextFileURI(std::string& uri, double& waitTime)
{
  CET_ASSERT_ONLY_ONE_THREAD();
...
inline void
art::CatalogInterface::updateStatus(std::string const& uri,
...
inline void
art::CatalogInterface::outputFileClosed(std::string const& module_label,
                                        std::string const& fileFQname)
{
  CET_ASSERT_ONLY_ONE_THREAD();
...
inline void
art::CatalogInterface::outputFileOpened(std::string const& module_label)
{
  CET_ASSERT_ONLY_ONE_THREAD();
...
inline void
art::CatalogInterface::outputModuleInitiated(std::string const& module_label,
                                             fhicl::ParameterSet const& pset)
{
  CET_ASSERT_ONLY_ONE_THREAD();
...
inline void
art::CatalogInterface::eventSelected(std::string const& module_label,
                                     EventID const& event_id,
                                     HLTGlobalStatus const& acceptance_info)
{
  CET_ASSERT_ONLY_ONE_THREAD();
...
inline bool
art::CatalogInterface::isSearchable()
{
  CET_ASSERT_ONLY_ONE_THREAD();
