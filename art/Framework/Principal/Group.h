...
namespace art {
  ...
  public:
    ...
    EDProduct const*
    uniqueProduct(TypeID const&) const override
    {
      return product_.get();
    }
    ...
    void
    setResolvers(BranchMapper const& bm, DelayedReader const& dr)
    {
  ...
  protected:
    ...
    [[noreturn]] void throwResolveLogicError(
