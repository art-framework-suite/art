...
#define MFSU_1_ARG_UPDATER_DECL(cb) \
  typename decltype(ActivityRegistry::s##cb)::result_type \
  updateStatusTo##cb(typename decltype(ActivityRegistry::s##cb)::slot_type::argument_type)

#define MFSU_1_ARG_UPDATER_DEFN(cb) \
  typename decltype(ActivityRegistry::s##cb)::result_type \
  MFStatusUpdater:: \
  updateStatusTo##cb(typename decltype(ActivityRegistry::s##cb)::slot_type::argument_type arg1 [[gnu::unused]])

#define MFSU_2_ARG_UPDATER_DECL(cb) \
  typename decltype(ActivityRegistry::s##cb)::result_type \
  updateStatusTo##cb(typename decltype(ActivityRegistry::s##cb)::slot_type::first_argument_type, \
                     typename decltype(ActivityRegistry::s##cb)::slot_type::second_argument_type)

#define MFSU_2_ARG_UPDATER_DEFN(cb) \
  typename decltype(ActivityRegistry::s##cb)::result_type \
  MFStatusUpdater:: \
  updateStatusTo##cb(typename decltype(ActivityRegistry::s##cb)::slot_type::first_argument_type arg1 [[gnu::unused]], \
                     typename decltype(ActivityRegistry::s##cb)::slot_type::second_argument_type arg2 [[gnu::unused]])
...
public:
  ...
  MFStatusUpdater&
  operator=(MFStatusUpdater const&) = delete;

  MFStatusUpdater&
  operator=(MFStatusUpdater&&) = delete;
...
private:
  ...
  void preModuleWithPhase(ModuleDescription const& desc, std::string const& phase = {});
  void postModuleWithPhase(ModuleDescription const& desc, std::string const& phase = {});
