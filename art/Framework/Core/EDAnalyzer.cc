...
namespace art {
  ...
  bool
  EDAnalyzer::doBeginRun(RunPrincipal const& rp, CPC_exempt_ptr cpc)
  {
    detail::CPCSentry sentry{current_context_, cpc};
  ...
  bool
  EDAnalyzer::doEndRun(RunPrincipal const& rp, CPC_exempt_ptr cpc)
  {
    detail::CPCSentry sentry{current_context_, cpc};
    Run const r{rp, moduleDescription_, this};
    endRun(r);
  ...
  bool
  EDAnalyzer::doBeginSubRun(SubRunPrincipal const& srp, CPC_exempt_ptr cpc)
  {
    detail::CPCSentry sentry{current_context_, cpc};
  ...
  bool
  EDAnalyzer::doEndSubRun(SubRunPrincipal const& srp, CPC_exempt_ptr cpc)
  {
    detail::CPCSentry sentry{current_context_, cpc};
    SubRun const sr{srp, moduleDescription_, this};
    endSubRun(sr);
