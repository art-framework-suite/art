...
art::ProductInfo
art::detail::consumes_dependency(
...
art::ProductInfo
art::detail::consumes_view_dependency(
  ProductInfo const& prod_info,
  std::string const& module_name,
  std::string const& current_process,
  std::map<std::string, std::set<std::string>> const& viewable_products)
{
  assert(prod_info.consumableType == ProductInfo::ConsumableType::ViewElement);
...
art::detail::consumed_products_for_module(
  std::string const& current_process,
