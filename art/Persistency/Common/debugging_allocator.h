...
namespace art {
  ...
  public:
    ...
    template <class U>
    debugging_allocator(debugging_allocator<U> const&) throw() : dummy('u')
    {}
    ...
    pointer
    allocate(size_type num, void const* hint = 0)
    {
    ...
    void
    construct(pointer p, T const& value)
    {
      new ((void*)p) T(value);
    }
  ...
  bool
  operator==(debugging_allocator<X> const&,
             debugging_allocator<Y> const&) throw()
  {
    return true;
  }
