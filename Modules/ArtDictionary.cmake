...
MACRO(art_dictionary)
  ...
  IF(ART_PERSISTENCY_COMMON)
    ...
    SET(ART_DICT_DICTIONARY_LIBRARIES
      ${ART_PERISTENCY_COMMON} ${ART_UTILITIES} ${ART_DICT_DICTIONARY_LIBRARIES}
      )
  else()
    SET(ART_DICT_DICTIONARY_LIBRARIES art_Persistency_Common art_Utilities ${ART_DICT_DICTIONARY_LIBRARIES} )
  endif()
  build_dictionary(DICTIONARY_LIBRARIES ${ART_DICT_DICTIONARY_LIBRARIES} ${ART_DICT_DEFAULT_ARGS} ${ART_DICT_EXTRA_ARGS})
